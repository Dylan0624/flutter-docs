...
- [ ] 嘗試 Provider 套件
- [ ] 理解狀態管理的最佳實踐
- [ ] 是整個標題 (Flutter Development Documentation)
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  '已完成: ${todos.where((todo) => todo.isCompleted).length}',
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                    color: Colors.green,
                  ),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                            '建立於 ${todo.createdAt.day}/${todo.createdAt.month} ${todo.createdAt.hour}:${todo.createdAt.minute.toString().padLeft(2, '0')}',
